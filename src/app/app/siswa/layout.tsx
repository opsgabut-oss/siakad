...
export default async function SiswaLayout({
  ...
  return (
    <div className="flex-1 min-h-screen bg-slate-950 text-slate-100 flex flex-col">
      {/* Top Navbar */}
      <header className="sticky top-0 z-40 bg-slate-900 border-b border-slate-800 shadow-md no-print">
      ...
      <footer className="bg-slate-900 border-t border-slate-800 py-3 px-4 sticky bottom-0 z-40 no-print">
